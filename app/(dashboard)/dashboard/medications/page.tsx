                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {currentData.map((med, index) => (
                    <div key={med.id} className="relative bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-[0_0_20px_rgba(14,165,233,0.25)] dark:hover:shadow-[0_0_20px_rgba(14,165,233,0.15)] transition-all duration-300 hover:border-sky-300 dark:hover:border-sky-700 flex flex-col group">
                      ...
                      {/* BAGIAN KANAN ATAS: TOMBOL AKSI & NOMOR URUT MENGGUNAKAN HTML BUTTON STANDAR */}
                        ...
                        {isAdmin && (
                          <div className="flex items-center gap-1 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300 pr-2 pt-1.5">
                            ...
                            <button 
                              ...
                              className="flex items-center justify-center h-8 w-8 bg-white/80 backdrop-blur-sm dark:bg-slate-900/80 text-sky-600 dark:text-sky-400 border border-slate-200 dark:border-slate-700 hover:bg-sky-100 dark:hover:bg-sky-900/60 hover:text-sky-700 dark:hover:text-sky-300 rounded-lg shadow-sm transition-all" 
                            ...
                            <button 
                              ...
                              className="flex items-center justify-center h-8 w-8 bg-white/80 backdrop-blur-sm dark:bg-slate-900/80 text-amber-600 dark:text-amber-500 border border-slate-200 dark:border-slate-700 hover:bg-amber-100 dark:hover:bg-amber-900/60 hover:text-amber-700 dark:hover:text-amber-400 rounded-lg shadow-sm transition-all" 
                            ...
                            {isSuperAdmin && (
                              <button 
                                ...
                                className="flex items-center justify-center h-8 w-8 bg-white/80 backdrop-blur-sm dark:bg-slate-900/80 text-red-600 dark:text-red-400 border border-slate-200 dark:border-slate-700 hover:bg-red-100 dark:hover:bg-red-900/60 hover:text-red-700 dark:hover:text-red-300 rounded-lg shadow-sm transition-all" 
