...
export default function HealthBentoCards({ scores, lang }: Props) {
  const cards = [
    { label: lang === 'id' ? "Kualitas Air" : "Water Quality", score: scores.waterQuality, color: "text-blue-500", bg: "bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-800", icon: Activity, isNull: false },
    { label: lang === 'id' ? "Perawatan" : "Maintenance", score: scores.maintenance, color: "text-amber-500", bg: "bg-amber-50 dark:bg-amber-900/20 border-amber-100 dark:border-amber-800", icon: RefreshCw, isNull: false },
    { label: lang === 'id' ? "Kesehatan Ikan" : "Fish Health", score: scores.fishHealth, color: "text-rose-500", bg: "bg-rose-50 dark:bg-rose-900/20 border-rose-100 dark:border-rose-800", icon: HeartPulse, isNull: false },
    { label: lang === 'id' ? "Beban Biologis" : "Bioload", score: scores.bioload, color: "text-purple-500", bg: "bg-purple-50 dark:bg-purple-900/20 border-purple-100 dark:border-purple-800", icon: Box, isNull: false },
